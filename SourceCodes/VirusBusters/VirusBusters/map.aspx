                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="portlet light ">
                              ...
                              <label id="L2"></label>
                              <label id="L3"></label>
                                <button id="button123" onclick="writeUserData('0001', 'Peter Pan', 'PeterPan@wtf.com', 'http://www.google.com')"></button>
...
alert("Your browser does not support geolocation");
 ...
 function bloodbank(){
   ...
   starCountRef.on('value', function(snapshot) {
     document.getElementById("L" + i).innerHTML = snapshot.val().latitude;
