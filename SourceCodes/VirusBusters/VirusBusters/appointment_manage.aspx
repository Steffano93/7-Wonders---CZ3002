            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <div class="m-heading-1 border-green m-bordered">
                        <h3>Instructions/Notifcations</h3>
                        <p> Some meaningful instructions/notifcations here </p>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>Manage Appointment
                                    </div>
                                    <div class="tools"> </div>
                                </div>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            ...
                                                            <li>
                                                                <a href="appointment_cancel.html">
                                                                    <i class="icon-tag"></i> Cancel
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
