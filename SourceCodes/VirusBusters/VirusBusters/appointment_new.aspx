                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane active" id="tab1">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="input-group input-medium date date-picker" data-date-format="dd/mm/yyyy" data-date-start-date="+0d">
                                                                    <input id="date" type="text" class="form-control" name="appt_date" readonly>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select id="type" name="appt_type" class="form-control" onchange='onSelect()'>
                                                                    <option value="">-- Please select appointment type --</option>
                                                                    <option value="cervicalscreening">Polyclinic</option>
                                                                    <option value="chas">CHAS Clinic</option>
                                                                    <option value="breastscreening">Breast Screening</option>
                                                                    <option value="bloodbank">Blood Bank</option>
                                                                    <option value="quitcentres">Quit Centres</option>
                                                                    <option value="cervicalscreening">Cervical Screening</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select id="location" name="location" class="form-control">
                                                                    ...
                                                                    <option value="cervicalscreening">Serangoon</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <select id="time" name="appt_time" class="form-control">
                                                                    <option value="">Please select time</option>
                                                                    <option value="AF">0800</option>
                                                                    <option value="AL">0900</option>
                                                                    <option value="DZ">1000</option>
                                                                    <option value="DZ">1100</option>
                                                                    <option value="DZ">1200</option>
                                                                    <option value="DZ">1400</option>
                                                                    <option value="DZ">1500</option>
                                                                    <option value="DZ">1600</option>
                                                                    <option value="DZ">1700</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <textarea id="remarks" class="form-control" rows="3" name="remarks"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="tab-pane" id="tab4">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <p class="form-control-static" data-display="appt_date"> </p>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Appointment Time:</label>
                                                            <div class="col-md-4">
                                                                <p class="form-control-static" data-display="appt_time"> </p>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-4">
                                                                <p class="form-control-static" data-display="appt_type"> </p>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3">Remarks:</label>
                                            ...
                                            <div class="form-actions">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        ...
                                                        <a class="btn btn-outline green button-next">
                                                            Continue
                                                            <i class="fa fa-angle-right"></i>
                                                        </a>
                                                        <a id="submitbtn" href="javascript:;" class="btn green button-submit">
                                                            Submit
